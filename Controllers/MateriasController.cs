...
namespace AprendaMaisSistema.Controllers
{
    public class MateriasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MateriasId,NomeMaterias")] Materias materias)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MateriasId,NomeMaterias")] Materias materias)
        {
        ...
        {
          return (_context.Materias?.Any(e => e.MateriasId == id)).GetValueOrDefault();
        }
    }
}
