...
namespace AprendaMaisSistema.Controllers
{
    public class ProfessoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProfessoresId,NomeProfessores")] Professores professores)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProfessoresId,NomeProfessores")] Professores professores)
        {
        ...
        {
          return (_context.Professores?.Any(e => e.ProfessoresId == id)).GetValueOrDefault();
        }
    }
}
