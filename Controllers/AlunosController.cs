...
namespace AprendaMaisSistema.Controllers
{
    public class AlunosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AlunosId,NomeAlunos,EmailAlunos,FoneAlunos,CpfAlunos,SexoAlunos")] Alunos alunos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AlunosId,NomeAlunos,EmailAlunos,FoneAlunos,CpfAlunos,SexoAlunos")] Alunos alunos)
        {
